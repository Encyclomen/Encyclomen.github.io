...
__\-__ *The Essence of Contextual Understanding in Theory of Mind: A Study on Question Answering with Story Characters.* (ACL 2025) <br>
__Chulun Zhou\*__, Qiujing Wang\*, Mo Yu, Xiaoqian Yue, Rui Lu, Jiangnan Li, Yifan Zhou, Shunchi Zhang, Jie Zhou, Wai Lam. <br>
#### **2023**
__\-__ *HyperNetwork-based Decoupling to Improve Model Generalization for Few-Shot Relation Extraction.* (EMNLP 2023) <br>
Liang Zhang\*, __Chulun Zhou\*__, Fandong Meng, Jinsong Su, Yidong Chen, Jie Zhou. <br>
__\-__ *A Multi-Task Multi-Stage Transitional Training Framework for Neural Chat Translation.* <br>
**Chulun Zhou**, Yunlong Liang, Fandong Meng, Jie Zhou, Jinan Xu, Hongji Wang, Min Zhang, Jinsong Su. (TPAMI). <br>
__\-__ *RC3: Regularized Contrastive Cross-lingual Cross-modal Pre-training.* (ACL 2023 Findings) <br>
**Chulun Zhou**, Yunlong Liang, Fandong Meng, Jinan Xu, Jinsong Su, Jie Zhou. <br>
#### **2022**
...
__\-__ *Confidence Based Bidirectional Global Context Aware Training Framework for Neural Machine Translation.* (ACL 2022) <br>
**Chulun Zhou**, Fandong Meng, Jie Zhou, Min Zhang, Hongji Wang, Jinsong Su. <br>
__\-__ *A Novel Multi-domain Machine Reading Comprehension Model with Domain Interference Mitigation.* (Neurocomputing) <br>
**Chulun Zhou**, Zhihao Wang, Shaojie He, Haiying Zhang, Jinsong Su. <br>
#### **2021**
__\-__ *Towards Making the Most of Dialogue Characteristics for Neural Chat Translation.* (EMNLP 2021) <br>
Yunlong Liang\*, __Chulun Zhou\*__, Fandong Meng, Jinan Xu, Yufeng Chen, Jinsong Su and Jie Zhou.
__\-__ *Exploring Dynamic Selection of Branch Expansion Orders for Code Generation.* (ACL 2021) <br>
Hui Jiang\*, __Chulun Zhou\*__, Fandong Meng, Biao Zhang, Jie Zhou, Degen Huang, Qingqiang Wu, Jinsong Su. <br>
#### **2020**
__\-__ *Exploring Contextual Word-level Style Relevance for Unsupervised Style Transfer.* (ACL 2020) <br>
**Chulun Zhou**, Liangyu Chen, Jiachen Liu, Xinyan Xiao, Jinsong Su, Sheng Guo, Hua Wu. <br>
__\-__ *A Novel Graph-based Multi-modal Fusion Encoder for Neural Machine Translation.* (ACL 2020) <br>
Yongjing Yin, Fandong Meng, Jinsong Su, **Chulun Zhou**, Zhengyuan Yang, Jie Zhou, Jiebo Luo. <br>
__\-__ *Modeling Discourse Structure for Document-level Neural Machine Translation.* (ACL 2020 Workshop) <br>
Junxuan Chen, Xiang Li, Jiarui Zhang, **Chulun Zhou**, Jianwei Cui, Bin Wang, Jinsong Su. <br>
__\-__ *An External Knowledge Enhanced Graph-based Neural Network for Sentence Ordering.* (JAIR) <br>
Yongjing Yin, Shaopeng Lai, Linfeng Song, **Chulun Zhou**, Xianpei Han, Junfeng Yao and Jinsong Su. <br>
__\-__ *Multi-modal Neural Machine Translation with Deep Semantic Interactions.* (Information Science) <br>
Jinsong Su, Jinchang Chen, Hui Jiang, **Chulun Zhou**, Huan Lin, Yubin Ge, Qingqiang Wu and Yongxuan Lai. <br>
#### **2019**
__\-__ Graph-based Neural Sentence Ordering. (IJCAI 2019) <br>
Yongjing Yin, Linfeng Song, Jinsong Su, Jiali Zeng, **Chulun Zhou** and Jiebo Luo. <br>
